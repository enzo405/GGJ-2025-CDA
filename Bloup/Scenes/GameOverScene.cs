...
public class GameOverScene(ContentManager content, GraphicsDeviceManager graphics, GameStart game) : SceneBase(content, graphics, game)
{
    ...
    public override void Draw(GameTime gameTime, SpriteBatch spriteBatch)
    {
        ...
        spriteBatch.DrawString(font, "Press any key to restart", new Vector2(game?.ScreenHeight ?? 200, game?.ScreenWidth ?? 200), Color.Red, 0, Vector2.Zero, 2, SpriteEffects.None, 0);
